...
Kayak is the search layer. It does not try to own OCR, document parsing,
extraction, or answer generation.

[Get started](installation.md){ .md-button .md-button--primary }
[Quickstart](quickstart.md){ .md-button }
[Where Kayak Fits](where-kayak-fits.md){ .md-button }
[Python API](api.md){ .md-button }

## Common workflows

**Local plain-text retrieval** — input starts as text strings, one object owns encoding and search. → [Text Encoders](text-encoders.md), [Usage Patterns](usage-patterns.md)
...
| If you want to... | Open... |
| --- | --- |
| understand what Kayak does and does not own | [Where Kayak Fits](where-kayak-fits.md) |
