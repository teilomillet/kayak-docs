...
other mixed-layout documents, parse or extract them before handing text or
token-level vectors to Kayak.
...
| If you want to... | Open... |
| --- | --- |
| understand the search-layer boundary | [Where Kayak Fits](where-kayak-fits.md) |
